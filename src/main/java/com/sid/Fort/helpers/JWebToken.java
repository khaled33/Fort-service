...
public class JWebToken {
    ...
    private static final String SECRET_KEY = "grhetrcy1243JHGFYDµµ5YTRFazertgfvjk"; //@TODO Add Signature here
    private static final char[] HEX_ARRAY = "0123456789ABCDEF".toCharArray();
    private static final String ISSUER = "Fort";
    ...
    public JWebToken(String sub, JSONArray aud, long expires) {
        ...
        payload.put("iat", new Date(System.currentTimeMillis()).getTime());
    ...
    public boolean isValid() {
        return payload.getLong("exp") > (new Date(System.currentTimeMillis()).getTime()) //token not expired
